...
//     category: null
//   });
//   const [editExistingImages, setEditExistingImages] = useState([]); // Images already in the portfolio
//   const [editNewImages, setEditNewImages] = useState([]); // New images to add
//   const [editNewPreviews, setEditNewPreviews] = useState([]); // Previews for new images
...
//   // Handle edit portfolio - open edit modal
//   const handleEditPortfolio = (portfolio) => {
//     setEditingPortfolio(portfolio);
//     setEditFormData({
//       title: portfolio.title || '',
//       category: categoryOptions.find(opt => opt.value === portfolio.category?.toLowerCase()) || null
//     });
//     // Set existing images from portfolio
//     setEditExistingImages(portfolio.images || []);
//     setEditNewImages([]);
//     setEditNewPreviews([]);
...
//   // Handle edit image selection - APPEND new images
...
//   // Remove an existing image from edit
//   const handleRemoveExistingImage = (indexToRemove) => {
//     setEditExistingImages(prev => prev.filter((_, index) => index !== indexToRemove));
//   };

//   // Remove a new image from edit
//   const handleRemoveNewImage = (indexToRemove) => {
//     URL.revokeObjectURL(editNewPreviews[indexToRemove]);
//     setEditNewImages(prev => prev.filter((_, index) => index !== indexToRemove));
//     setEditNewPreviews(prev => prev.filter((_, index) => index !== indexToRemove));
//   };
...
//     try {
//       // Validation
//       if (editExistingImages.length === 0 && editNewImages.length === 0) {
...
//       // For now, since there's no edit endpoint in the backend that handles image updates,
//       // we'll just show a notification. You would need to implement the backend endpoint.
//       // The typical approach would be to delete and re-create, or have a proper update endpoint.
      
//       console.log('📝 Edit portfolio data:', {
//         id: editingPortfolio.id,
//         title: editFormData.title,
//         category: editFormData.category.value,
//         existingImages: editExistingImages.length,
//         newImages: editNewImages.length
//       });

//       // Show notification about limited edit support
//       showNotification('Edit functionality requires backend update endpoint. Title/category changes noted.');
...
//     } catch (err) {
//       console.error('❌ Error editing portfolio:', err);
      
//       let errorMessage = 'Failed to edit portfolio. Please try again.';
//       if (err.message) {
//         errorMessage = err.message;
//       }
...
//       {/* Edit Portfolio Modal - Full page overlay */}
...
//               {/* Edit Form */}
//               <form onSubmit={handleEditSubmit} className="space-y-4 max-w-5xl p-6">
//                 {/* Image Upload */}
//                 <div>
//                   <label 
//                     htmlFor="edit-portfolio-image-upload"
//                     className="block w-full bg-transparent border border-white px-4 py-3 font-dm-sans text-gray-500 cursor-pointer hover:border-gray-400 transition-colors"
//                   >
//                     UPLOAD IMAGE/IMAGES
//                   </label>
//                   <input
//                     id="edit-portfolio-image-upload"
//                     type="file"
//                     accept="image/*"
//                     multiple
...
//                   {/* Display existing images and new images */}
