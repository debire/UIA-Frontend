...
function AdminPortfolio() {
  ...
  const categoryOptions = [
    { value: 'portraits', label: 'Portraits' },
    { value: 'editorial', label: 'Editorial' },
    { value: 'productlifestyle', label: 'Product Lifestyle' },
    { value: 'streettravel', label: 'Street + Travel' }
  ];
  ...
  const stats = {
    portraits: portfolios.filter(p => p.category?.toLowerCase() === 'portraits').length,
    editorial: portfolios.filter(p => p.category?.toLowerCase() === 'editorial').length,
    productLifestyle: portfolios.filter(p => p.category?.toLowerCase() === 'productlifestyle').length,
    streetTravel: portfolios.filter(p => p.category?.toLowerCase() === 'streettravel').length
  };
          ...
          >
            <nav className="space-y-6">
              <Link
                to="/admin/dashboard"
                onClick={() => setIsMobileMenuOpen(false)}
                className={`block font-dm-mono text-lg ${isActive('/admin/dashboard') ? 'font-medium' : 'font-normal'
                  } hover:text-gray-300 transition-colors`}
              >
                DASHBOARD
              </Link>
              <Link
                to="/admin/orders"
                onClick={() => setIsMobileMenuOpen(false)}
                className={`block font-dm-mono text-lg ${isActive('/admin/orders') ? 'font-medium' : 'font-normal'
                  } hover:text-gray-300 transition-colors`}
              >
                ORDERS
              </Link>
              <Link
                to="/admin/store"
                onClick={() => setIsMobileMenuOpen(false)}
                className={`block font-dm-mono text-lg ${isActive('/admin/store') ? 'font-medium' : 'font-normal'
                  } hover:text-gray-300 transition-colors`}
              >
                STORE
              </Link>
              <Link
                to="/admin/portfolio"
                onClick={() => setIsMobileMenuOpen(false)}
                className={`block font-dm-mono text-lg ${isActive('/admin/portfolio') ? 'font-medium' : 'font-normal'
                  } hover:text-gray-300 transition-colors`}
              >
                PORTFOLIO
              </Link>
              <Link
                to="/admin/pic-of-week"
                onClick={() => setIsMobileMenuOpen(false)}
                className={`block font-dm-mono text-lg ${isActive('/admin/pic-of-week') ? 'font-medium' : 'font-normal'
                  } hover:text-gray-300 transition-colors`}
              >
                P&POTW
              </Link>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="flex gap-6 md:gap-8 mb-8 overflow-x-auto pb-2">
                <button
                  onClick={() => setActiveCategory('portraits')}
                  className={`font-dm-sans text-sm md:text-base uppercase whitespace-nowrap transition-colors ${activeCategory === 'portraits'
                      ? 'text-white font-medium'
                      : 'text-gray-500 font-normal hover:text-gray-300'
                    }`}
                >
                ...
                <button
                  onClick={() => setActiveCategory('editorial')}
                  className={`font-dm-sans text-sm md:text-base uppercase whitespace-nowrap transition-colors ${activeCategory === 'editorial'
                      ? 'text-white font-medium'
                      : 'text-gray-500 font-normal hover:text-gray-300'
                    }`}
                >
                ...
                <button
                  onClick={() => setActiveCategory('productlifestyle')}
                  className={`font-dm-sans text-sm md:text-base uppercase whitespace-nowrap transition-colors ${activeCategory === 'productlifestyle'
                      ? 'text-white font-medium'
                      : 'text-gray-500 font-normal hover:text-gray-300'
                    }`}
                >
                ...
                <button
                  onClick={() => setActiveCategory('streettravel')}
                  className={`font-dm-sans text-sm md:text-base uppercase whitespace-nowrap transition-colors ${activeCategory === 'streettravel'
                      ? 'text-white font-medium'
                      : 'text-gray-500 font-normal hover:text-gray-300'
                    }`}
                >
