...
function CategoryPage() {
  ...
  // Get background image based on category (keeping same images, will be changed later)
  const getCategoryBg = () => {
    const categoryMap = {
      'portraits': digitalBg,
      'editorial': natureBg,
      ...
      <section className="relative w-full h-[40vh] md:h-[80vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col">
          ...
          <div className="flex-1 flex items-center justify-center px-4">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium text-white font-kyiv-serif tracking-wider text-center">
